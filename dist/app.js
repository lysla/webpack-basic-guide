...
window.jQuery = window.$ = (jquery__WEBPACK_IMPORTED_MODULE_0___default()); // Bootstrap Framework
...
navbarMain.addEventListener('show.bs.collapse', function () {
  ...
  var scrollableNav = document.querySelector('#navbarMain');
  (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_4__.disableBodyScroll)(scrollableNav);
});
navbarMain.addEventListener('hidden.bs.collapse', function () {
  $('.navbar-toggler .hamburger').removeClass('is-active');
  var scrollableNav = document.querySelector('#navbarMain');
  (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_4__.enableBodyScroll)(scrollableNav);
}); //#endregion
})();
